...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('public.contatos') }}">Contatos</a>
                    </li>                  
                </ul>
            </div>
            <div class="text-end">
    ...
    <script>
        ...
        navLinks.forEach(link => {
            const href = new URL(link.href, window.location.origin).pathname; // Usa window.location.origin para URLs relativas
            if (href === currentPage) {
