                    ...
                    <div class="row g-3">
                        <div class="form-floating col-md-4 ">
                            <select class="form-control" id="tipoContrato" name="tipoContrato" required>
                                ...
                                <option value="1" {{ old('tipoContrato') == '1' ? 'selected' : '' }}>Diarista
                                </option>
                        ...
                        <div class="form-floating  col-md-4">
                            <select class="form-select form-control" id="lotacao" name="lotacao" required>
                        ...
                        <div class="form-floating  col-md-4">
                            <select class="form-select form-control" id="equipe" name="equipe" required>
                                <option value="">Selecione</option>
                                <option value="Armação" {{ old('equipe') == 'Armação' ? 'selected' : '' }}>Armação
                                </option>
                                ...
                                <option value="Esquadria" {{ old('equipe') == 'Esquadria' ? 'selected' : '' }}>
                                    Esquadria
                                </option>
                                <option value="Hidráulica" {{ old('equipe') == 'Hidráulica' ? 'selected' : '' }}>
                                    Hidráulica
                                </option>
                                <option value="Logística" {{ old('equipe') == 'Logística' ? 'selected' : '' }}>
                                    Logística
                                </option>
                                <option value="Metálica" {{ old('equipe') == 'Metálica' ? 'selected' : '' }}>Metálica
                                </option>
                                <option value="Pintura" {{ old('equipe') == 'Pintura' ? 'selected' : '' }}>Pintura
                                </option>
                                <option value="Piso" {{ old('equipe') == 'Piso' ? 'selected' : '' }}>Piso</option>
                                <option value="Revestimento" {{ old('equipe') == 'Revestimento' ? 'selected' : '' }}>
                                    Revestimento</option>
                                <option value="Técnica" {{ old('equipe') == 'Técnica' ? 'selected' : '' }}>Técnica
                                </option>
                            </select>
                        ...
                        <div class="form-floating col-md-4">
                            <input type="text" class="form-control valor-input" id="remuneracao" name="remuneracao"
                                placeholder="R$ 0,00" value="{{ old('remuneracao') }}" required>
                        ...
                        <div class="form-floating col-md-4">
                            <select class="form-select form-control" id="situacao" name="situacao" required>
                                <option value="">Selecione</option>
                                ...
                                <option value="3" {{ old('situacao') == '3' ? 'selected' : '' }}>Contrato de
                                    experiência</option>
                                <option value="4" {{ old('situacao') == '4' ? 'selected' : '' }}>Desligado
                                </option>
                                ...
                                <option value="8" {{ old('situacao') == '8' ? 'selected' : '' }}>Temporário
                                </option>
                            </select>
                        ...
                        <div class="form-floating col-md-6">
                            <input type="date" class="form-control" id="admissao" name="admissao"
                                placeholder="Data de admissão" value="{{ old('admissao') }}" required>
