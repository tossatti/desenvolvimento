...
@section('content')
    <div class="card border-light mt-4 mb-4 shadow">
        <div class="card-header hstack gap-2">
            <span><strong>Editar subgrupo de insumos</strong></span>
        ...
        <div class="card-body">
            <x-alert />
            <form action="{{ route('subgrupoInsumo.update', ['subgrupoInsumo' => $subgrupoInsumo->id]) }}" method="POST">
                @csrf
                @method('PUT')
                {{-- Insumo --}}
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-sm-12 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="subgrupo" name="subgrupo" value="{{ $subgrupoInsumo->subgrupo, old('subgrupo') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
