                ...
                <div class="accordion-item ">
                    ...
                    <div id="dados" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form name="dados" id="dados" action="{{ route('users.update', ['user' => $user->id]) }}"
            ...
            <div class="accordion mb-3">
                <div class="accordion-item">
                    ...
                    <div id="docs" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form name="docs" id="docs" action="#" method="POST" class="row g-3">
                                @csrf
                                @method('PUT')
                                <div class="col-md-6">
            ...
            <div class="accordion mb-3">
                <div class="accordion-item">
                    ...
                    <div id="bancario" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form name="bancario" id="bancario" action="#" method="POST" class="row g-3">
                                @csrf
                                @method('PUT')
                                <div class="col-md-6">
            ...
            <div class="accordion mb-3">
                <div class="accordion-item">
                    ...
                    <div id="endereco" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form name="endereco" id="endereco" action="#" method="POST" class="row g-3">
                                @csrf
                                @method('PUT')
                                <div class="col-md-9">
            ...
            <div class="accordion mb-3">
                <div class="accordion-item">
                    ...
                    <div id="contrato" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form name="contrato" id="contrato" action="#" method="POST" class="row g-3">
                                @csrf
                                @method('PUT')
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-control" id="equipe" name="equipe"
                                        ...
                                        <option value="{{ '11', old('equipe') }}">Técnica</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-control" id="disponibilidade" name="disponibilidade"
                                        aria-label="Default select example">
                                        <option selected>Selecione</option>
                                        <option value="{{ '1', old('disponibilidade') }}">Afastado</option>
                                        <option value="{{ '2', old('disponibilidade') }}">Aviso</option>
                                        <option value="{{ '3', old('disponibilidade') }}">Contrato de experiência</option>
                                        <option value="{{ '4', old('disponibilidade') }}">Desligado</option>
                                        <option value="{{ '5', old('disponibilidade') }}">Efetivo</option>
                                        <option value="{{ '6', old('disponibilidade') }}">Em contratação</option>
                                        <option value="{{ '7', old('disponibilidade') }}">Férias</option>
                                        <option value="{{ '8', old('disponibilidade') }}">Temporário</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
            ...
            <div class="accordion mb-3" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <div id="esocial" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <form name="esocial" id="esocial" action="#" method="POST" class="row g-3">
                                @csrf
                                @method('PUT')
