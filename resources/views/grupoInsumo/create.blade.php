...
@section('content')
    <div class="card border-light mt-4 mb-4 shadow">
        <div class="card-header hstack gap-2">
            <span><strong>Cadastrar grupo de insumos</strong></span>
        ...
        <div class="card-body">
            <x-alert />
            <form action="{{ route('grupoInsumo.store') }}" method="POST">
                @csrf
                @method('POST')
                {{-- Insumo --}}
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-sm-12 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="grupo" name="grupo" placeholder="Insira o grupo a ser criado" value="{{ old('grupo') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
